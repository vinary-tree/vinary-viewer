        ...
        [:div.vv-ext-sect
         ...
         [:div.vv-ext-install
          [:input.vv-ext-input {:placeholder "Chrome Web Store URL or extension ID"
                                ...
                                ;; the keymap resolver derives "is a text field focused?" from
                                ;; document.activeElement now, so keystrokes reach this field without any
                                ;; per-component mirroring (which leaked on unmount). ADR-0032.
