...
(rf/reg-sub :ui/tree-open      (fn [db _] (get-in db [:ui :tree-open] #{})))
(rf/reg-sub :ui/tree-expanding (fn [db _] (get-in db [:ui :tree-expanding] #{})))
(rf/reg-sub :ui/tree-restoring? (fn [db _] (get-in db [:ui :tree-restoring?] false)))
