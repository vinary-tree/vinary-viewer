...
(defn active-doc
  ...
  [db path]
  (when-let [eid (eid-for-path db path)]
    (d/pull db [:doc/path :doc/kind :doc/language :doc/base-dir :doc/text :doc/html :doc/toc :doc/source-toc
                ...
                :doc/streaming? :doc/stream-progress :doc/stream-note :doc/git-root :doc/git] eid)))
