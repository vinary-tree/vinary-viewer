...
{:ds/rev 0
 :ui {:theme "spacemacs-dark"
      ...
      :content-width nil           ; CSS-px .vv-content clientWidth (ONE debounced ResizeObserver
                                   ;   mirror; nil until first measure) — the width-adaptive diff
                                   ;   default's input (ADR-0043)
