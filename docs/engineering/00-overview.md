...
| [`07-docs-and-screenshot-gates.md`](07-docs-and-screenshot-gates.md) | `scripts/screenshots.cjs` (cross-platform headless regeneration), the PlantUML render-regression greps, the diagram-catalog honesty loops, and the pinned diagram toolchain. |
